...
public class MyCalendarController extends BaseController {
  ...
  protected List<MyCalendar> doPost(MyCalendar myCalendar, HttpServletRequest request,
  ...
  public String add(MyCalendar myCalendar, HttpServletRequest request, HttpServletResponse response,
      Model model) {

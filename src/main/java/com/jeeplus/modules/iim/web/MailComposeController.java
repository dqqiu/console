...
public class MailComposeController extends BaseController {
  ...
  public String sendLetter(User user, HttpServletRequest request, HttpServletResponse response,
      Model model) {
  ...
  public String list(MailCompose mailCompose, HttpServletRequest request,
    ...
    Page<MailCompose> page =
        mailComposeService.findPage(new MailPage<MailCompose>(request, response), mailCompose);
  ...
  public String save(MailCompose mailCompose, Model model, HttpServletRequest request,
  ...
  public String delete(MailCompose mailCompose, RedirectAttributes redirectAttributes) {
    ...
    return "redirect:" + Global.getAdminPath()
        + "/iim/mailCompose/?repage&orderBy=sendtime desc&status=" + mailCompose.getStatus();
  }

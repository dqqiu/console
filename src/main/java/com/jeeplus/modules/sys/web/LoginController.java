...
public class LoginController extends BaseController {
  ...
  public String loginFail(HttpServletRequest request, HttpServletResponse response, Model model) {
    ...
    String username =
        WebUtils.getCleanParam(request, FormAuthenticationFilter.DEFAULT_USERNAME_PARAM);
    boolean rememberMe =
        WebUtils.isTrue(request, FormAuthenticationFilter.DEFAULT_REMEMBER_ME_PARAM);
  ...
  public String index(HttpServletRequest request, HttpServletResponse response) {
    ...
    //
    request.setAttribute("count", 0);// 未读通知条数
    ...
    Page<MailBox> mailPage =
        mailBoxService.findPage(new MailPage<MailBox>(request, response), mailBox);

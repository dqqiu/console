...
public class TestDataMainService extends CrudService<TestDataMainDao, TestDataMain> {
  ...
  public TestDataMain get(String id) {
    ...
    testDataMain
        .setTestDataChild2List(testDataChild2Dao.findList(new TestDataChild2(testDataMain)));
    testDataMain
        .setTestDataChild3List(testDataChild3Dao.findList(new TestDataChild3(testDataMain)));
    return testDataMain;
  }

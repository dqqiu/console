...
public class EChartsLineTimeLineTag extends BodyTagSupport {
  ...
  public int doEndTag() throws JspException {
     ...
     * '2007-01-01','2008-01-01','2009-01-01','2010-01-01','2011-01-01' ], label : { formatter :
     * function(s) { return s.slice(0, 4); } }, autoPlay : true, playInterval : 1000 },
     */
    ...
    /**
     * legend : { x:'right', 'data':['GDP','金融','房地产','第一产业','第二产业','第三产业'], 'selected':{
     * 'GDP':true, '金融':false, '房地产':true, '第一产业':false, '第二产业':false, '第三产业':false } },
     */
    ...
    /**
     * yAxis : [ { 'type':'value', 'name':'GDP（亿元）', 'max':53500 }, { 'type':'value',
     * 'name':'其他（亿元）' } ],
     */
    // Y轴数据封装并解析
